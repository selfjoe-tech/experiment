// app/profile/[username]/ProfileMediaPageClient.tsx
"use client";
...
export default function ProfileMediaPage() {
  ...
  const sortedItems = useMemo(() => {
    ...
    switch (sortBy) {
      case "newest":
        ...
        break;
      case "views":
        copy.sort((a: any, b: any) => (b.views || 0) - (a.views || 0));
        break;
      default:
        copy.sort(
          (a: any, b: any) =>
            (b.score || b.views || 0) - (a.score || a.views || 0)
        );
    }
  ...
  return (
    <div className="px-3 sm:px-4">
      {/* SEO/a11y hidden heading */}
      <h1 className="sr-only">
        {username}&apos;s GIFs and images on Upskirt Candy
      </h1>
...
// ... keep your Stat, ProfileTabs, ActionRow helpers as you had them ...
